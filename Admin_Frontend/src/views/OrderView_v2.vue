        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <tr v-for="order in filteredOrders" :key="order.orderId">
                ...
                <td>
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteMenuModal"
                    v-on:click="onSelectOrder(order)" :disabled="order.status?.statusId === 7">
              ...
              <!-- test 訂單詳情區 -->
              <tr class="collapse" :id="'collapseOrder' + order.orderId" v-for="order in filteredOrders"
                :key="'detail-' + order.orderId">
                <td colspan="8">
